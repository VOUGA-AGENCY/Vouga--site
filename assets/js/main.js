(function(){
  ...
  var I18N = {
    pt: {
      ...
      heroSub: 'Adotamos uma abordagem system-first para identificar onde software, automação e IA podem gerar maior impacto operacional.',
      heroSubMobile: 'Adotamos uma abordagem system-first para identificar onde software, automação e IA podem gerar maior impacto operacional.',
      ...
      useCase1CardLabel: 'Saber mais sobre Centro Integrado de Operações Industriais',
      ...
      useCase2CardLabel: 'Saber mais sobre Inteligência de Produção e Energia',
      ...
      useCase3CardLabel: 'Saber mais sobre Sistema de Conhecimento Técnico',
      ...
      useCase4CardLabel: 'Saber mais sobre Sistema Comercial e de Orçamentação',
      ...
      useCase5CardLabel: 'Saber mais sobre Sistema de Conhecimento Estratégico',
      ...
      useCase6CardLabel: 'Saber mais sobre Agente de Voz com Memória Contextual',
